		...
		<div className="navbar bg-zinc-950 fixed z-20">
			...
			<div className="flex-none gap-4">
				...
				{!isLogin() && (
					<>
						<Link href={'/login'}>
							<button className="py-2 px-4 text-sm font-medium border border-zinc-600 rounded-md">
								Log In
							</button>
						</Link>
						<Link href={'/register'}>
							<button className="py-2 px-4 text-sm font-medium bg-slate-100 text-zinc-900 rounded-md">
								Sign Up
							</button>
						</Link>
					</>
